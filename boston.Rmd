...
This project uses a public dataset named "Boston" from the R package - "MASS". It is a famous dataset for machine learning. However, I have made adjustment to this dataset to make overall analysis interesting and unique. First, I changed the names of most of the columns into names that are more representative; Second, I induced some missing values in 2 of the 14 columns, "black" and "lstat", and I will use R to impute the missing values with algorithm.

This Boston housing dataset studies the effects of a range of variables on median house prices in Boston in **late 70s**, United States. 
